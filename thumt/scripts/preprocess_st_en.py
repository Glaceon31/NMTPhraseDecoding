...
if __name__ == "__main__":
    ...
    os.system('perl ~/moses/mosesdecoder/scripts/tokenizer/tokenizer.perl -no-escape < tmpprocess.norm > tmpprocess.tok')
    os.system('perl ~/moses/mosesdecoder/scripts/tokenizer/lowercase.perl < tmpprocess.tok > tmpprocess.out')
